  ...
  return (
    <div className="flex gap-2 px-4 py-3 overflow-x-auto items-center" style={{ scrollbarWidth: 'none' }}>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="shrink-0 flex flex-col items-center gap-1 px-3 py-2 rounded-2xl text-xs font-medium bg-gray-50 text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-all border border-dashed border-gray-300"
        style={{ minWidth: 60 }}
      >
